const RULES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      '포트폴리오', '이력서', '커리어', '데드라인', 'kpi', 'okr', '회의록',
      '피드백', '협업', '전시 기획', '프론트엔드', '메일 드래프트', '연구실',
  ...
  },
  {
    ...
    keywords: [
      ...
      '배우', '연습', '지식', '학원', '과제', '논문', '스터디', '책 요약',
      '터치디자이너', 'touchdesigner', '회화', '전공',
  ...
  },
  {
    slug: 'inner',
    keywords: [
      '일기', '감정', '명상', '성찰', '마음', '스트레스', '감사', '다짐',
      '자기', '회고', '반성', '동기', '의미', '가치', '가치관', '집중',
      '불안', '행복', '우울', '기분', '자존감', '번아웃', '조급', '멘탈',
      '내면', '성찰 일기', '감정 회고',
      'diary', 'journal', 'reflect', 'meditat', 'mood', 'gratitude',
    ],
  },
  {
    slug: 'relationship',
