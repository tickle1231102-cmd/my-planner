-- Run this in the SAME Supabase project as the live app.
-- Live app project ref: nnulpjepaearokjujbis
-- Dashboard URL: https://supabase.com/dashboard/project/nnulpjepaearokjujbis/sql/new
--
-- If you run this on a different project, the website will keep saying
-- push tables are missing.
